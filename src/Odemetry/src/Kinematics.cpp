...
Eigen::Matrix3d Kinematics::dfk_drho(Eigen::Vector3d q, Eigen::VectorXd rho_opt, Eigen::VectorXd rho_fix) {
    Eigen::Matrix3d mtx;
    autoFunc_d_fk_dc(q.data(), rho_opt.data(), rho_fix.data(), mtx.data());
    return mtx;
}

Eigen::Matrix<double, 9, 3> Kinematics::dJ_dq(Eigen::Vector3d q, Eigen::VectorXd rho_opt, Eigen::VectorXd rho_fix) {
    Eigen::Matrix<double, 9, 3> mtx;
    autoFunc_dJ_dq(q.data(), rho_opt.data(), rho_fix.data(), mtx.data());
    return mtx;
}

Eigen::Matrix<double, 9, 3> Kinematics::dJ_drho(Eigen::Vector3d q, Eigen::VectorXd rho_opt, Eigen::VectorXd rho_fix) {
    Eigen::Matrix<double, 9, 3> mtx;
...
void Kinematics::autoFunc_fk_derive(const double in1[3], const double in2[3], const double
in3[5], double p_bf[3])
{
    double p_bf_tmp;
    double t2;
...
void Kinematics::autoFunc_d_fk_dq(const double in1[3], const double in2[3], const double
...
void Kinematics::autoFunc_d_fk_dc(const double in1[3], const double [3], const double [5],
                      double d_fk_dc[9])
{
    double t2;
    double t3;
...
void Kinematics::autoFunc_dJ_dq(const double in1[3], const double in2[3], const double in3[5],
                    double dJ_dq[27])
{
    double t10;
    double t13;
...
void Kinematics::autoFunc_dJ_dpho(const double in1[3], const double [3], const double [5],
                      double dJ_dpho[27])
{
    double t11;
    double t12;
